<template>
	<transition name="viewer-fade">
		<div v-show="show" class="my-priview-image el-image-viewer__wrapper" :style="{ 'z-index': zIndex }">
			<div class="el-image-viewer__mask"></div>
			<!-- header -->
			<div class="my-p_i-header">{{ index + 1 }}/{{ list.length }}</div>
			<!-- CLOSE -->
			<span class="el-image-viewer__btn el-image-viewer__close" @click="close"><i class="close-btn el-icon-circle-close"></i></span>
			<!-- ARROW -->
...
export default {
	...
	methods: {
		...
		open(options) {
			...
			this.appendEl = options.appendEl || this.appendEl;
